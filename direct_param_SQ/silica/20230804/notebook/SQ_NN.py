...
model_name = 'ft3'
export_path_aug = './saved_model/SQ_L2_variation/SQ_L2_variation_aug_'+model_name+'/'
model_name_aug = 'SQ_L2_variation_aug_'+model_name
export_name_aug = export_path_aug + model_name_aug

export_path_decoder = './saved_model/SQ_L2_variation/SQ_L2_variation_decoder_'+model_name+'/'
model_name_decoder = 'SQ_L2_variation_decoder_'+model_name
